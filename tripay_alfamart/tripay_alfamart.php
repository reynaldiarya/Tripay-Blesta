 ...
 */
class TripayAlfamart extends NonmerchantGateway
{
	/**
	...
	public function __construct()
	{
		...
		Language::loadLang("tripay_alfamart", null, dirname(__FILE__) . DS . "language" . DS);
	}
	...
	public function getSettings(array $meta = null)
	{
		...
		$select_options = [
			'1440' => Language::_('TripayAlfamart.active_period.1day', true)
		];
		...
		$rules = [
			'merchant_code' => [
				'valid' => [
					'rule' => 'isEmpty',
					'negate' => true,
					'message' => Language::_('TripayAlfamart.!error.merchant_code.valid', true)
				]
			],
			'api_key' => [
				'valid' => [
					'rule' => 'isEmpty',
					'negate' => true,
					'message' => Language::_('TripayAlfamart.!error.api_key.valid', true)
				]
			],
			'private_key' => [
				'valid' => [
					'rule' => 'isEmpty',
					'negate' => true,
					'message' => Language::_('TripayAlfamart.!error.private_key.valid', true)
				]
			],
			'active_period' => [
				'valid' => [
					'rule' => ['in_array', ['1440']],
					'message' => Language::_('TripayAlfamart.!error.active_period.valid', true)
				]
			],
		];
