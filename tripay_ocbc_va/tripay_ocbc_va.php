 ...
 */
class TripayOcbcVa extends NonmerchantGateway
{
	/**
	...
	public function __construct()
	{
		...
		Language::loadLang("tripay_ocbc_va", null, dirname(__FILE__) . DS . "language" . DS);
	}
	...
	public function getSettings(array $meta = null)
	{
		...
		$select_options = [
			'1440' => Language::_('TripayOcbcVa.active_period.1day', true),
			'2880' => Language::_('TripayOcbcVa.active_period.2day', true),
			'4320' => Language::_('TripayOcbcVa.active_period.3day', true),
			'10080' => Language::_('TripayOcbcVa.active_period.7day', true),
			'20160' => Language::_('TripayOcbcVa.active_period.14day', true),
			'43200' => Language::_('TripayOcbcVa.active_period.30day', true)
		];
		...
		$rules = [
			'merchant_code' => [
				'valid' => [
					'rule' => 'isEmpty',
					'negate' => true,
					'message' => Language::_('TripayOcbcVa.!error.merchant_code.valid', true)
				]
			],
			'api_key' => [
				'valid' => [
					'rule' => 'isEmpty',
					'negate' => true,
					'message' => Language::_('TripayOcbcVa.!error.api_key.valid', true)
				]
			],
			'private_key' => [
				'valid' => [
					'rule' => 'isEmpty',
					'negate' => true,
					'message' => Language::_('TripayOcbcVa.!error.private_key.valid', true)
				]
			],
			'active_period' => [
				'valid' => [
					'rule' => ['in_array', ['1440', '2880', '4320', '10080', '20160', '43200']],
					'message' => Language::_('TripayOcbcVa.!error.active_period.valid', true)
				]
			],
		];
