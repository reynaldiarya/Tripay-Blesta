 ...
 */
class TripayQrisc extends NonmerchantGateway
{
	/**
	...
	public function __construct()
	{
		...
		Language::loadLang("tripay_qrisc", null, dirname(__FILE__) . DS . "language" . DS);
	}
	...
	public function getSettings(array $meta = null)
	{
		...
		$select_options = [
			'1440' => Language::_('TripayQrisc.active_period.1day', true)
		];
		...
		$rules = [
			'merchant_code' => [
				'valid' => [
					'rule' => 'isEmpty',
					'negate' => true,
					'message' => Language::_('TripayQrisc.!error.merchant_code.valid', true)
				]
			],
			'api_key' => [
				'valid' => [
					'rule' => 'isEmpty',
					'negate' => true,
					'message' => Language::_('TripayQrisc.!error.api_key.valid', true)
				]
			],
			'private_key' => [
				'valid' => [
					'rule' => 'isEmpty',
					'negate' => true,
					'message' => Language::_('TripayQrisc.!error.private_key.valid', true)
				]
			],
			'active_period' => [
				'valid' => [
					'rule' => ['in_array', ['1440']],
					'message' => Language::_('TripayQrisc.!error.active_period.valid', true)
				]
			],
		];
